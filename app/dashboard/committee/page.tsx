      ...
      <div className="container mx-auto max-w-screen-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
          ...
          <div className="glass rounded-2xl p-5 shadow-xl border border-white/30 hover:border-purple-500/40 transition-all hover:-translate-y-1">
            ...
            <div className="text-3xl font-bold text-purple-600">{playerStats.total}</div>
          </div>

          <div className="glass rounded-2xl p-5 shadow-xl border border-white/30 hover:border-green-500/40 transition-all hover:-translate-y-1">
            <div className="flex items-center justify-between mb-3">
            ...
            <div className="text-sm text-gray-600 mb-1">Eligible Players</div>
            <div className="text-3xl font-bold text-green-600">{playerStats.eligible}</div>
          </div>

          <div className="glass rounded-2xl p-5 shadow-xl border border-white/30 hover:border-orange-500/40 transition-all hover:-translate-y-1">
            <div className="flex items-center justify-between mb-3">
            ...
            <div className="text-sm text-gray-600 mb-1">Active Rounds</div>
            <div className="text-3xl font-bold text-orange-600">{activeRounds.length}</div>
          </div>
        </div>

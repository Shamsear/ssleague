          ...
          <div className="glass rounded-3xl p-6 shadow-xl border border-white/30">
            ...
            {expandedSections.ratings && (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <Link href="/dashboard/committee/player-star-upgrades" className="group glass rounded-2xl p-4 border border-white/20 hover:border-orange-500/50 transition-all duration-300 shadow-md hover:shadow-xl hover:-translate-y-1 relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-orange-500/10 to-transparent rounded-full -mr-12 -mt-12 group-hover:scale-150 transition-transform duration-500"></div>
                  <div className="relative">
                    <div className="flex items-center justify-between mb-3">
                      <div className="p-2.5 rounded-lg bg-gradient-to-br from-orange-500 to-orange-600 text-white shadow-md">
                    ...
                    <h4 className="font-bold text-gray-800 group-hover:text-orange-600 transition-colors mb-1">⚡ Star Upgrades</h4>
                    <p className="text-xs text-gray-600">Manage player star upgrades</p>
                  </div>
                </Link>

                <Link href="/dashboard/committee/update-player-ratings" className="group glass rounded-2xl p-4 border border-white/20 hover:border-teal-500/50 transition-all duration-300 shadow-md hover:shadow-xl hover:-translate-y-1 relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-teal-500/10 to-transparent rounded-full -mr-12 -mt-12 group-hover:scale-150 transition-transform duration-500"></div>
                  <div className="relative">
                    <div className="flex items-center justify-between mb-3">
                      <div className="p-2.5 rounded-lg bg-gradient-to-br from-teal-500 to-teal-600 text-white shadow-md">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                        </svg>
                      </div>
                      <svg className="w-5 h-5 text-gray-400 group-hover:text-teal-600 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                      </svg>
                    </div>
                    <h4 className="font-bold text-gray-800 group-hover:text-teal-600 transition-colors mb-1">🔄 Update Ratings</h4>
                    <p className="text-xs text-gray-600">Bulk update player ratings</p>
                  </div>
                </Link>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <Link href="/dashboard/committee/salary-transactions" className="group glass rounded-2xl p-4 border border-white/20 hover:border-purple-500/50 transition-all duration-300 shadow-md hover:shadow-xl hover:-translate-y-1 relative overflow-hidden">
                  ...
                  <div className="relative">
                    ...
                    <h4 className="font-bold text-gray-800 group-hover:text-purple-600 transition-colors mb-1">💎 Real Player Salaries</h4>
                    <p className="text-xs text-gray-600">View salary transactions by team</p>
                  </div>
                </Link>

                <Link href="/dashboard/committee/match-rewards" className="group glass rounded-2xl p-4 border border-white/20 hover:border-green-500/50 transition-all duration-300 shadow-md hover:shadow-xl hover:-translate-y-1 relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-green-500/10 to-transparent rounded-full -mr-12 -mt-12 group-hover:scale-150 transition-transform duration-500"></div>
                  <div className="relative">
                    <div className="flex items-center justify-between mb-3">
                      <div className="p-2.5 rounded-lg bg-gradient-to-br from-green-500 to-green-600 text-white shadow-md">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                      </div>
                    ...
                    <h4 className="font-bold text-gray-800 group-hover:text-green-600 transition-colors mb-1">🏆 Match Rewards</h4>
                    <p className="text-xs text-gray-600">View match reward transactions</p>
                  </div>
                </Link>
                ...
                <Link href="/dashboard/committee/tournament-rewards-view" className="group glass rounded-2xl p-4 border border-white/20 hover:border-purple-500/50 transition-all duration-300 shadow-md hover:shadow-xl hover:-translate-y-1 relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-purple-500/10 to-transparent rounded-full -mr-12 -mt-12 group-hover:scale-150 transition-transform duration-500"></div>
                  <div className="relative">
                    <div className="flex items-center justify-between mb-3">
                      <div className="p-2.5 rounded-lg bg-gradient-to-br from-purple-500 to-blue-600 text-white shadow-md">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
                        </svg>
                      </div>
                    ...
                    <h4 className="font-bold text-gray-800 group-hover:text-purple-600 transition-colors mb-1">🏆 Tournament Rewards</h4>
                    <p className="text-xs text-gray-600">Position, completion & knockout rewards</p>
                  </div>
                </Link>
          ...
          <div className="glass rounded-3xl p-6 shadow-xl border border-white/30">
            ...
            {expandedSections.fantasy && (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Link href="/dashboard/committee/tournament-rewards" className="group glass rounded-2xl p-4 border border-white/20 hover:border-green-500/50 transition-all duration-300 shadow-md hover:shadow-xl hover:-translate-y-1 relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-green-500/10 to-transparent rounded-full -mr-12 -mt-12 group-hover:scale-150 transition-transform duration-500"></div>
                  <div className="relative">
                    <div className="flex items-center justify-between mb-3">
                      <div className="p-2.5 rounded-lg bg-gradient-to-br from-green-500 to-emerald-600 text-white shadow-md">
                    ...
                    <h4 className="font-bold text-gray-800 group-hover:text-green-600 transition-colors mb-1">💰 Tournament Rewards</h4>
                    <p className="text-xs text-gray-600">Distribute end rewards</p>
                  </div>
                </Link>
                ...
                <Link href="/dashboard/committee/tournament-rewards-view" className="group glass rounded-2xl p-4 border border-white/20 hover:border-purple-500/50 transition-all duration-300 shadow-md hover:shadow-xl hover:-translate-y-1 relative overflow-hidden">
                  ...
                  <div className="relative">
                    ...
                    <h4 className="font-bold text-gray-800 group-hover:text-purple-600 transition-colors mb-1">🏆 View Tournament Rewards</h4>
                    <p className="text-xs text-gray-600">Position, Knockout & Completion</p>
                  </div>
                </Link>
